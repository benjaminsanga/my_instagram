    ...
    <BrowserRouter>
      ...
      >
        <div className="App" css={{width: '100vw'}}>
          ...
          <Navbar />
          <Wrapper>
            {/* <Route render={() => <Navigate to="/" />} /> */}{/* below is a workaround for following issue: when deployed to amplify, it's redirecting to a random hash url */}
            ...
            {(currentCredentials.authenticated && data.getUser === null) && <Navigate to="/createprofile" />}{/* if user is authenticated but profile record is not in db yet */}
          </Wrapper>
